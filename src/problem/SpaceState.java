...
/**
 * Space state is rappresent all possibility combination ov action,successor by
 * rootstate and cost
...
public class SpaceState {
    ...
    /**
     * We don't understand if method have to return threeTuple (action,state,cost)
     * or only states genereted by all action the second version implement a
     * threeTuple
     * @param state
     * @return
